...
function App() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-red-400 to-orange-400 flex flex-col items-center justify-center p-4">
      <div className="bg-red-50 rounded-lg p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-gray-800 mb-2">{t('appTitle')}</h1>
          <p className="text-gray-600 text-sm">{t('appSubtitle')}</p>
        </div>

        <div className="space-y-4">
          <Input placeholder={t('username')} className="bg-gray-200 border-none" />
          <Input placeholder={t('password')} type="password" className="bg-gray-200 border-none" />
          <Button
        ...
        <p className="text-center text-xs text-gray-500 mt-6">{t('copyright')}</p>
      </div>
    </div>
  )
  ...
  const UserSelectionView = () => (
    <div className="min-h-screen bg-gradient-to-b from-red-400 to-orange-400 flex flex-col items-center justify-center p-4">
      <div className="bg-red-50 rounded-lg p-8 w-full max-w-md">
        <h2 className="text-xl font-bold text-center mb-6">{t('userTypeSelect')}</h2>
        <div className="space-y-4">
          <Button
          ...
          >
            <div className="text-center">
              ...
              <div className="font-semibold">{t('supporter')}</div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-red-400 to-orange-400 flex flex-col items-center justify-center p-4">
        <div className="bg-red-50 rounded-lg p-8 w-full max-w-md">
          <div className="flex items-center mb-6">
            <Button variant="ghost" onClick={() => setCurrentView('login')} className="p-2">
              ←
            </Button>
          ...
          <div className="space-y-4">
            ...
            <select
              ...
              className="w-full p-3 bg-gray-200 rounded-lg border-none"
            >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Card className="border-orange-300">
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-xs text-gray-600">
                          Acesse materiais que podem ajudar pacientes oncológicos
                        </p>
                      </CardContent>
                    </Card>
          ...
          return (
            <div className="p-4">
              ...
              <div className="flex mb-4">
                ...
                <Button variant="outline" className="bg-orange-400 text-white rounded-l-none">
                  Pessoal
                </Button>
              </div>
            ...
            <div className="p-4">
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600">
                      Fundado em 25 de junho de 1998, o Grupo Pongaiense de Combate ao Câncer tem
                      desempenhado um papel fundamental no apoio a pacientes com câncer, oferecendo
                      suporte essencial àqueles que enfrentam a doença.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600">
                      Garantir que os pacientes de Pongaí tenham acesso a exames, medicamentos e
                      consultas quando esses serviços não estão disponíveis na rede pública.
                    </p>
                  </CardContent>
                </Card>
